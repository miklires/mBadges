...
public final class BadgeGiveEvent extends Event {
    ...
    public BadgeGiveEvent(boolean async, UUID playerId, Badge badge, BadgeOperationReason reason, String source) {
        super(async);
